...
log('\nnext steps:');
if (hasDocker) {
  log('1. start database (Docker desktop must be running and db port 5432 must not be in use(or change it from docker dev compose file and appsettings.development in backend folder) - Desktop on Win/Mac):');
